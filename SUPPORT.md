...
| Ordinary transforms | Affine residual propagation, USD reset-stack prefix/ancestor exclusion, preserved scene placement/up-axis; runtime descendants follow corrected globals; malformed matrix edits retain last-good globals and recover through the stage change sink; half scalar/vector/quaternion decoding | Affine and Z-up reset fixtures captured against explicit geometry; quaternion conversion checked against native axis-angle cases. Singular lighting, broader animated/native quaternion coverage and propagation performance remain unverified. Non-finite orientations, overflowing axis lengths and singular inverse ops produce diagnostics; scalar-axis translation/scale support remains open. Point-prototype hierarchy limits below still apply |
