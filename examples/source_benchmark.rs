...
fn main() {
    ...
    println!("instances_per_root={count} profile={} phase_timing={profiled} route_timing={routes} renderer=headless source=captured excludes=disk-io,plugin-startup,gpu samples=3",
