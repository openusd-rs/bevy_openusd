...
| Ordinary transforms | Affine residual propagation, USD reset-stack prefix/ancestor exclusion, preserved scene placement/up-axis; runtime descendants follow corrected globals; malformed matrix edits retain last-good globals and recover through the stage change sink | Affine and Z-up reset fixtures captured against explicit geometry; singular matrices are representable but singular lighting is not validated. Non-unit orientations and singular inverse ops produce diagnostics. Broader animated coverage, native quaternion parity and propagation performance remain unverified; point-prototype hierarchy limits below still apply |
