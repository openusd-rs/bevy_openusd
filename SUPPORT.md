...
| Ordinary transforms | Affine residual propagation, USD reset-stack prefix/ancestor exclusion, preserved scene placement/up-axis; runtime descendants follow corrected globals | Affine and Z-up reset fixtures captured against explicit geometry; singular matrices are representable but singular lighting is not validated. Malformed-update recovery, broader animated coverage and propagation performance remain unverified; point-prototype hierarchy limits below still apply |
