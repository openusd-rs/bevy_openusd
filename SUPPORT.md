...
| Viewer timeline | EditorBridge seek/play commands; Timeline pane with play/pause, stepping, start and typed seek; shared playback math with independent instances; inspected typed-seek and nonfinite-input rejection captures | Seek interaction uses injected egui input in an isolated native viewer; OS-level mouse/keyboard, play/pause/step/start buttons and broader overlay acceptance remain unverified |
