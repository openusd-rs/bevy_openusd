...
| Display primvars | Meshes/primitives and point prototypes inherit authored nonblocked constant display color/opacity; meshes and mesh point prototypes also inherit constant st/st0 UVs; local overrides, owner-local sampled indices, independent clocks and parent-edit invalidation | General shader primvar-reader networks and arbitrary per-texture UV sets remain incomplete; arbitrary nonconstant shape primvars are not projected |
