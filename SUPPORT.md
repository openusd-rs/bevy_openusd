...
| Materials | Preview surface channels including sampled scalar and textured clearcoat/roughness; scalar/opacity packing; explicit raw/sRGB; constant-valued MaterialX multiply/add/subtract/mix; graph fallback diagnostics | Textured graph arithmetic still approximated; color management, auto inference and per-texture UV semantics incomplete; coat mapping is not native BRDF parity |
